        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 flex flex-col hover:scale-105 transition duration-300">
            ...
            <ul className="space-y-4 mb-8 text-left flex-1">
              <li className="flex items-center gap-3 text-slate-600 dark:text-slate-300"><Check size={18} className="text-blue-500"/> 3 Análises / mês</li>
            </ul>
          ...
          <div className="bg-slate-900 dark:bg-blue-600 p-8 rounded-2xl shadow-2xl border border-slate-800 dark:border-blue-500 flex flex-col relative transform scale-105 z-10">
            ...
            <ul className="space-y-4 mb-8 text-left flex-1">
              <li className="flex items-center gap-3 text-slate-300"><Shield size={18} className="text-blue-400"/> Análises Ilimitadas</li>
              <li className="flex items-center gap-3 text-slate-300"><Zap size={18} className="text-blue-400"/> Raciocínio Avançado de IA</li>
              <li className="flex items-center gap-3 text-slate-300"><Star size={18} className="text-blue-400"/> Suporte Prioritário (24/7)</li>
            </ul>
            ...
            >
              {loading ? <Loader2 className="animate-spin" /> : (user?.isPro ? 'Plano Atual' : 'Fazer Upgrade')}
            </button>
          </div>

          {/* CUSTOM PLAN */}
          <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 flex flex-col hover:scale-105 transition duration-300">
            <h3 className="text-xl font-bold text-slate-800 dark:text-white mb-2">Escritórios</h3>
            <div className="text-4xl font-bold text-slate-900 dark:text-white mb-6">Contato</div>
            <ul className="space-y-4 mb-8 text-left flex-1">
              <li className="flex items-center gap-3 text-slate-600 dark:text-slate-300"><Check size={18} className="text-blue-500"/> Licença Multi-usuário</li>
            </ul>
