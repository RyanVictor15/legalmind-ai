...
import { User, Shield, Key, Save, Loader2, Menu } from 'lucide-react';
...
const Profile = () => {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      const payload = { firstName, lastName, twoFactorEnabled };
  ...
  const handleDeleteAccount = async () => {
    if (window.confirm("Tem certeza? Esta ação deletará todos os seus dados permanentemente.")) {
        try {
